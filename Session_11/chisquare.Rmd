...
```{r}
pchisq(chi.squared, df = 3 - 1, lower.tail = F) #rechts v. Graph interessant
#df: letzte rechte Klammer
```
...
## Aufgaben
- nehmen Sie zwei Texte im TigerXML-Format; (Wikipedia)
- extrahieren Sie die ersten 100 Autosemantika;
- teilen Sie diese Beobachtungen in A-, V- und N-Wörter auf, (H�kchen setzen)
- vergleichen Sie die beiden Häufigkeitsverteilungen mit Hilfe von dem Chi-Quadrat-Test. 4-/Mehr-Felder-Tabellen
